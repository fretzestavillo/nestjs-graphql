...
function _useFragment(options) {
  ...
  var currentDiff = React15.useMemo(function() {
    ...
    return diffToResult(cache2.diff(__assign(__assign({}, stableOptions), { returnPartialData: true, id: from3, query: cache2["getFragmentDoc"](fragment, fragmentName), optimistic })));
  ...
  return useSyncExternalStore(React15.useCallback(function(forceUpdate) {
    ...
    var subscription = cache2.watchFragment(stableOptions).subscribe({
      next: function(result2) {
        if (lib_default(result2, currentDiff))
          return;
  ...
  }, [cache2, stableOptions, currentDiff]), getSnapshot, getSnapshot);
}
